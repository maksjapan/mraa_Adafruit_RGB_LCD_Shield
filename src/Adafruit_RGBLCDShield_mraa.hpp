...
#ifndef ADAFRUIT_RGBLCDSHIELD_MRAA_HPP_
#define ADAFRUIT_RGBLCDSHIELD_MRAA_HPP_
...
class Adafruit_RGBLCDShield_mraa : public Print {
public:
  Adafruit_RGBLCDShield_mraa(unsigned int _busnumber = 0);
...
private:
  ...
  uint8_t _i2cAddr;
  Adafruit_MCP23017_mraa _i2c;
};


#endif /* ADAFRUIT_RGBLCDSHIELD_MRAA_HPP_ */
